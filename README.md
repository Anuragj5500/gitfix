...
---
```markdown
**GitFix** is an advanced Agentic AI system designed to automatically diagnose, repair, and verify broken Python code.
Unlike standard AI assistants, GitFix operates in a "Think-Execute-Verify" loop, ensuring that every fix it proposes is objectively functional.
---
## 📖 Project Overview
